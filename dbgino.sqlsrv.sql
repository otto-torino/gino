...
(3, NULL, 1, '2011-11-08 14:05:57', '2018-01-15 14:05:18', 'Implementazioni', 'implementazioni', NULL, NULL, '<p><img alt="plugin" src="contents/attachment/gino/plugin.jpg" style="float:left; margin-left:10px; margin-right:10px" />Le funzionalità di gino possono essere ampliate utilizzando i <strong>moduli aggiuntivi</strong> disponibili, oppure creando direttamente applicazioni con l''ausilo dell''applicazione "Creazione App" presente nell''area amministrativa.</p>
...
Occorre inoltre tenere presente che conviene installare col Composer soltanto i pacchetti esterni necessari, in quanto lo spazio richiesto potrebbe essere importante.</p>', '', 0, 1, 0, 0, NULL, 0, NULL, 0, NULL, NULL),
...
CREATE TABLE sys_layout_skin (
  ...
  highest tinyint NOT NULL DEFAULT '0',
