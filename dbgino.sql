...
CREATE TABLE `auth_registration_profile` (
  ...
  `add_information_module_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `buildapp_item` (
  ...
  `m2mtf_name` varchar(50) DEFAULT NULL,
  `m2mtf_model_name` varchar(50) DEFAULT NULL,
  `m2mtf_model_label` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `calendar_opt` (
  ...
  `day_chars` tinyint NOT NULL,
  `open_modal` tinyint(1) NOT NULL,
  `items_for_page` smallint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `page_entry` (
  ...
  `users_edit` varchar(255) DEFAULT NULL,
...
CREATE TABLE `post_opt` (
  `id` int NOT NULL,
  `instance` int NOT NULL,
  `last_post_number` int NOT NULL,
  `last_slideshow_view` tinyint(1) NOT NULL DEFAULT '0',
  `last_slideshow_number` tinyint DEFAULT NULL,
  `list_nfp` smallint DEFAULT NULL,
  `showcase_post_number` smallint DEFAULT NULL,
  `showcase_auto_start` tinyint(1) NOT NULL,
  `showcase_auto_interval` int NOT NULL,
  `evidence_number` smallint DEFAULT NULL,
  `evidence_auto_start` tinyint(1) DEFAULT NULL,
  `evidence_auto_interval` int DEFAULT NULL,
  `image_width` smallint DEFAULT NULL,
  `newsletter_post_number` smallint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_conf` (
  ...
  `query_cache_time` smallint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sys_conf` (`id`, `multi_language`, `dft_language`, `log_access`, `head_description`, `head_keywords`, `head_title`, `google_analytics`, `captcha_public`, `captcha_private`, `sharethis_public_key`, `disqus_shortname`, `email_admin`, `email_from_app`, `mobile`, `password_crypt`, `enable_cache`, `query_cache`, `query_cache_time`) VALUES
(1, 1, 1, 1, 'Content Management System', '', 'gino CMS', '', '', '', NULL, NULL, 'kkk@otto.to.it', 'no-reply@otto.to.it', 0, 'md5', 0, 0, NULL);
...
--
-- Indexes for table `auth_registration_profile`
--
ALTER TABLE `auth_registration_profile`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `auth_registration_profile_group`
--
ALTER TABLE `auth_registration_profile_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `auth_registration_request`
--
...
--
-- AUTO_INCREMENT for table `auth_registration_profile`
--
ALTER TABLE `auth_registration_profile`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `auth_registration_profile_group`
--
ALTER TABLE `auth_registration_profile_group`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `auth_registration_request`
--
ALTER TABLE `auth_registration_request`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nation`
  MODIFY `id` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
--
