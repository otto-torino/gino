 ...
 * @brief Contiene la definizione ed implementazione delal classe Gino.PageList
 * 
...
class PageList{
     ...
     * @return istanza di Gino.PageList
     */
    ...
    /**
     * @brief Recupera il valore dello start
     * @return valore iniziale limite elementi
     */
    public function start() 
    {
        $request = \Gino\Http\Request::instance();
        $start = cleanVar($request->REQUEST, 'start', 'int', '');

        return $start > 0 ? $start : 0;
    }

    /**
     * @brief Resoconto risultati
     * @description es. 1-10 di 100
     * @return resoconto
     */
    public function reassumedPrint()
    {
        ...
        if($this->_tot > 0)
        {
            ...
            $printTBL = sprintf('%d - %d di %d', $this->_start, $end, $this->_tot);
        }
    ...
    /**
     * @brief Numero di pagina con link
     * @param string $label etichetta pagina
     * @param string $params parametri url
     * @param bool $link se TRUE viene creato il link altrimenti no. Default TRUE.
     * @param array $opt
     *
     * @return codice html
     */
    ...
    /**
     * @brief Stampa i collegamenti con le pagine precedenti e successive
     * 
