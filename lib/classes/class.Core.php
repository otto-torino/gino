...
class Core {
    ...
    function __construct() {
        ...
        Loader::import('class/fields', array(
            ...
            '\Gino\FieldBuild',
            '\Gino\BooleanFieldBuild',
            '\Gino\CharFieldBuild',
            '\Gino\SlugFieldBuild',
            '\Gino\DateFieldBuild',
            '\Gino\DatetimeFieldBuild',
            '\Gino\DirectoryFieldBuild',
            '\Gino\EmailFieldBuild',
            '\Gino\EnumFieldBuild',
            '\Gino\FileFieldBuild',
            '\Gino\FloatFieldBuild',
            '\Gino\ForeignKeyFieldBuild',
            '\Gino\ImageFieldBuild',
            '\Gino\IntegerFieldBuild',
            '\Gino\ManyToManyFieldBuild',
            '\Gino\ManyToManyThroughFieldBuild',
            '\Gino\ManyToManyInlineFieldBuild',
            '\Gino\TextFieldBuild',
            '\Gino\TimeFieldBuild',
            '\Gino\YearFieldBuild',
            '\Gino\TagFieldBuild',
